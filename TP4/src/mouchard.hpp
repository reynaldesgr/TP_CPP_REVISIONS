// Gardien //---------------------------------------------------------------------------------------
#ifndef MOUCHARD_HPP_e2de9d8bffa542748c65a181aaf7a778
#define MOUCHARD_HPP_e2de9d8bffa542748c65a181aaf7a778
...
template <class T> class Mouchard : public T {
 ...
 //---------------------------------------------------------------------------------------Accesseurs
 public:
  static unsigned long getNbAffectation() { return nbAffectation_; }
  static unsigned long getNbConstruction() { return nbConstruction_; }
  static unsigned long getNbCopie() { return nbCopie_; }
  static unsigned long getNbMouvement() { return nbMouvement_; }

 public:
  //-----------------------------------------------------------------------------Constructeur defaut
  Mouchard() { ++nbConstruction_; }
